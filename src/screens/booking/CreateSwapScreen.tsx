...
const styles = StyleSheet.create({
  ...
  pointsCostText: { fontSize: 18, fontWeight: '700' },
  // Payment option
  ...
  paymentInput: {
    ...
    fontSize: 20,
    fontWeight: '600' },
  paymentTypeSummary: { fontSize: 15, fontStyle: 'italic' },
  // Dog selector
  ...
  dogSelectorTabText: { fontSize: 16, fontWeight: '600' },
  // Dog info
  carouselWrapper: { borderRadius: borderRadius.md, overflow: 'hidden', marginBottom: spacing.sm },
  dogInfo: { paddingTop: spacing.xs },
  dogInfoName: { fontSize: 20, fontWeight: '700', marginBottom: 2 },
  dogInfoBreed: { fontSize: 16, marginBottom: spacing.sm },
  dogInfoChips: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.xs, marginBottom: spacing.xs },
  dogInfoTemperament: { fontSize: 15, fontStyle: 'italic', marginTop: spacing.xs },
  ...
  dogRowName: { fontSize: 17, fontWeight: '600' },
  dogRowBreed: { fontSize: 15 },
  // Care details
  ...
  charCount: { fontSize: 14, textAlign: 'right', marginTop: spacing.xs },
  // Message
  messageInput: { borderWidth: 1, borderRadius: borderRadius.md, padding: spacing.md, fontSize: 16, minHeight: 80 },
  // Submit
